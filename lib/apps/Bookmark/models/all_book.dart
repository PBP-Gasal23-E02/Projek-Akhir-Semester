...
//
//     final Book = productFromJson(jsonString);
...
class Fields {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "Issued": "${issued!.year.toString().padLeft(4, '0')}-${issued!.month.toString().padLeft(2, '0')}-${issued!.day.toString().padLeft(2, '0')}",
        "Title": title,
...
enum Bookshelves {
    COOKBOOKS_AND_COOKING
}

final bookshelvesValues = EnumValues({
    "Cookbooks and Cooking": Bookshelves.COOKBOOKS_AND_COOKING
});
